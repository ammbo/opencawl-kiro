...
- [x] 1. Add `openclaw_result` column to calls table
  - [x] 1.1 Create migration `migrations/0016_add_openclaw_result.sql`
    - Add `ALTER TABLE calls ADD COLUMN openclaw_result TEXT;` with a descriptive comment
    - _Requirements: 1.1, 1.2, 1.3_

- [x] 2. Implement POST /api/openclaw/results endpoint
  - [x] 2.1 Create `functions/api/openclaw/results.js` with `onRequestPost`
  ...
  - [x] 2.2 Write property test: Results round-trip (Property 1)
  ...
  - [x] 2.3 Write property test: Invalid payloads rejected (Property 2)
  ...
  - [x] 2.4 Write property test: Result length enforcement (Property 3)
...
- [x] 3. Checkpoint — Verify results endpoint
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Update GET /api/openclaw/status to include summary, openclaw_result, goal
  - [x] 4.1 Modify `functions/api/openclaw/status.js` response object
  ...
  - [x] 4.2 Write property test: Status returns all stored fields (Property 4)
...
- [x] 5. Update SKILL.md and CLI script
  - [x] 5.1 Update `public/opencawl/SKILL.md` with results documentation
  ...
  - [x] 5.2 Add `results` command to `public/opencawl/scripts/opencawl.mjs`
...
- [x] 6. Checkpoint — Verify API and CLI changes
  - Ensure all tests pass, ask the user if questions arise.

- [x] 7. Implement CallDetail modal component
  - [x] 7.1 Create `src/dashboard/components/CallDetail.jsx`
  ...
  - [x] 7.2 Write property test: Transcript formatting (Property 5)
...
- [x] 8. Wire CallDetail into CallLog and Home page
  - [x] 8.1 Update `src/dashboard/components/CallLog.jsx` with click handling
  ...
  - [x] 8.2 Update `src/dashboard/pages/Home.jsx` to manage CallDetail state
